...
Vagrant.configure("2") do |config|
  ...
  # TODO setup SSH with private key different from default
  # config.ssh.username = "test_vagrant_box"
  config.ssh.insert_key = false
  # config.ssh.private_key_path = "./test_vagrant_box"
end
